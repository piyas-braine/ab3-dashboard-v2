...
const SetupOrganizationStep1 = () => {
  return (
    <div className="px-4 sm:px-0 py-[47.84px] flex-[7.22] min-w-0">
      <div className="py-16 px-10 max-w-[424px] mx-auto w-full  bg-bg-gray-100 rounded-lg">
        <div className="flex justify-center">
          <div className="w-[56px] h-[55px] text-[#27272E]">
            <OrganizationStep1Icon />
          </div>
        </div>

        <H2 className="pt-[30px] text-center">Set up your Organization</H2>
