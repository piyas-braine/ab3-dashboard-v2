  ...
  return (
    <div className="pt-[33.5px] pb-[57px] px-4 sm:px-7 xl:px-[60px] min-[1400px]:pl-[83px] min-[1400px]:pr-[102px] bg-[#F7FAFC]">
      <div className="max-w-[513px] mx-auto w-full flex flex-col items-center">
        ...
        <h1 className="mt-[68.22px] text-text-primary-cetacean-blue text-[28px] leading-[100%] font-bold text-center">
          Welcome to AB3 <span className="text-text-primary-red">Medical</span>
        </h1>
        ...
        <p className="mt-[128px] max-w-[447px] mx-auto text-[18px] leading-[30px] font-medium text-text-body-light text-center">
