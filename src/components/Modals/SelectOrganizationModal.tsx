...
const SelectOrganizationModal = ({
  ...
  return (
    <div
      className="p-4 w-[263px] max-h-[368px] absolute z-[500] top-2 -left-[14px] bg-bg-default-white rounded-lg"
    ...
    >
      ...
      <div className="mt-[15px] w-full max-h-[282px] h-full overflow-y-auto select-organization-scrollbar">
